...
<div class="footer_section layout_padding">
    <div class="container">
        <div class="location_main">
            <div class="location_text"><img src="{{ asset('images/map-icon.png') }}"><span class="padding_left_10"><a href="#">Location</a></span></div>
            <div class="location_text center"><img src="{{ asset('images/call-icon.png') }}"><span class="padding_left_10"><a href="#">Call : 01 1234567890</a></span></div>
            <div class="location_text right"><img src="{{ asset('images/mail-icon.png') }}"><span class="padding_left_10"><a href="#">demo@gmail.com</a></span></div>
        </div>
